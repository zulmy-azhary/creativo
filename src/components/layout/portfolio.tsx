export const Portfolio: React.FC = () => {
  return (
    <section className="flex justify-center w-full">
      <div className="container flex flex-col my-24 2xl:gap-x-7 2xl:flex-row px-7 md:px-7 lg:mb-0 lg:px-28 xl:my-52 gap-y-2">
        <h2 className="text-xl 2xl:translate-y-8 basis-1/6">Our Portfolio</h2>
